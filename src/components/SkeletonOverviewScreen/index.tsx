...
export function SkeletonOverviewScreen() {
  ...
  return (
    <Container>
      ...
      <Chart>
        <Animated.View style={{ height: '100%', backgroundColor: theme.colors.shape, borderRadius: 125 }}>
          <Animated.View style={{ width: '30%', height: '100%', opacity: 0.5, backgroundColor: theme.colors.background, transform: [{ translateX: translateX3 }] }}></Animated.View>
        </Animated.View>
      </Chart>
